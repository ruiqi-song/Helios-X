...
VisualizeDetectedObjects::VisualizeDetectedObjects() : arrow_height_(0.5), label_height_(1.0)
{
  ...
  std::string markers_out_topic = "/visual/objects_markers";

//  std::string object_src_topic = "/fusion/detector/object";
    std::string object_src_topic = "/lidar/obstacles";
...
void VisualizeDetectedObjects::DetectedObjectsCallback(const waytous_msgs::DetectedObjectArray &in_objects)
{
...
VisualizeDetectedObjects::ObjectsToCentroids(const waytous_msgs::DetectedObjectArray &in_objects)
{
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToBoxes(const waytous_msgs::DetectedObjectArray &in_objects)
{
  ...
  for (auto const &object: in_objects.objects)
  {
        ...
        (object.dimensions.x + object.dimensions.y + object.dimensions.z) < object_max_linear_size_)
    {
      ...
      //std::cout << "-------------------the obstacle label is : " << object.label << std::endl;
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToModels(const waytous_msgs::DetectedObjectArray &in_objects)
{
  ...
  for (auto const &object: in_objects.objects)
  {
        ...
        (object.dimensions.x + object.dimensions.y + object.dimensions.z) < object_max_linear_size_)
    {
      ...
      if(object.label == "car")
      {
        model.mesh_resource = "file:///home/ricky/lidar/pointpillars/src/detected_objects_visualizer/models/car.dae";
      }
      else if (object.label == "person")
      {
        model.mesh_resource = "file:///home/ricky/lidar/pointpillars/src/detected_objects_visualizer/models/person.dae";
      }
      else if (object.label == "bicycle" || object.label == "bike")
      {
        model.mesh_resource = "file:///home/ricky/lidar/pointpillars/src/detected_objects_visualizer/models/bike.dae";
      }
      else if (object.label == "bus")
      {
        model.mesh_resource = "file:///home/ricky/lidar/pointpillars/src/detected_objects_visualizer/models/bus.dae";
      }
      else if(object.label == "truck")
      {
        model.mesh_resource = "file:///home/ricky/lidar/pointpillars/src/detected_objects_visualizer/models/truck.dae";
      }
      else
      {
        model.mesh_resource = "file:///home/ricky/lidar/pointpillars/src/detected_objects_visualizer/models/box.dae";
      }
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToHulls(const waytous_msgs::DetectedObjectArray &in_objects)
{
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToArrows(const waytous_msgs::DetectedObjectArray &in_objects)
{
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToLabels(const waytous_msgs::DetectedObjectArray &in_objects)
{
...
bool VisualizeDetectedObjects::IsObjectValid(const waytous_msgs::DetectedObject &in_object)
{
//  if (!in_object.valid ||
if(
  ...
  {
     // std::cout << "vis is valid >>>>>>>>>>>>>>>>>>>>>!!!!!!!!!!!!!!!!!!!!!!!!!!@@@@@@@@@@@@@@@@@" << std::endl;
    return false;
  }
  return true;
}//end IsObjectValid
