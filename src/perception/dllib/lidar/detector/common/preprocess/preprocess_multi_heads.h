...
class PreprocessPointsMultiHeadsCuda {
private:
    // initializer list
...
public:
     ...
     */
    PreprocessPointsMultiHeadsCuda(const int num_threads, const int num_point_feature, const int num_inds_for_scan,
                         ...
                         const float min_z_range); // point cloud range
    ~PreprocessPointsMultiHeadsCuda();
