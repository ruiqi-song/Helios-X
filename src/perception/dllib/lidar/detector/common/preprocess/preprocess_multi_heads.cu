...
#include "preprocess_multi_heads.h"
...
PreprocessPointsMultiHeadsCuda::PreprocessPointsMultiHeadsCuda(
    ...
    GPU_CHECK(cudaMalloc(reinterpret_cast<void **>(&dev_pillar_point_feature_in_coors_),
                         grid_y_size_ * grid_x_size_ * max_num_points_per_pillar_ * num_point_feature_ *
                         sizeof(float)));
...
void PreprocessPointsMultiHeadsCuda::DoPreprocessPointsCuda(
