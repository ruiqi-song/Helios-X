// Generated by gencpp from file waytous_msgs/DetectedObject.msg
// DO NOT EDIT!


#ifndef WAYTOUS_MSGS_MESSAGE_DETECTEDOBJECT_H
#define WAYTOUS_MSGS_MESSAGE_DETECTEDOBJECT_H
...
struct DetectedObject_
{
  ...
  _user_defined_info_type user_defined_info;
   ...
   typedef uint8_t _fusion_state_type;
  _fusion_state_type fusion_state;
  ...
  typedef boost::shared_ptr< ::waytous_msgs::DetectedObject_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::waytous_msgs::DetectedObject_<ContainerAllocator> const> ConstPtr;

}; // struct DetectedObject_

typedef ::waytous_msgs::DetectedObject_<std::allocator<void> > DetectedObject;

typedef boost::shared_ptr< ::waytous_msgs::DetectedObject > DetectedObjectPtr;
typedef boost::shared_ptr< ::waytous_msgs::DetectedObject const> DetectedObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::waytous_msgs::DetectedObject_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::waytous_msgs::DetectedObject_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::waytous_msgs::DetectedObject_<ContainerAllocator1> & lhs, const ::waytous_msgs::DetectedObject_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.fusion_state == rhs.fusion_state &&
    lhs.type == rhs.type &&
...
template <class ContainerAllocator>
struct IsFixedSize< ::waytous_msgs::DetectedObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::waytous_msgs::DetectedObject_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::waytous_msgs::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::waytous_msgs::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::waytous_msgs::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::waytous_msgs::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::waytous_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
    return "a637865f5193f87ef33de257271cf209";
  }

  static const char* value(const ::waytous_msgs::DetectedObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa637865f5193f87eULL;
  static const uint64_t static_value2 = 0xf33de257271cf209ULL;
};

template<class ContainerAllocator>
struct DataType< ::waytous_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
    return "waytous_msgs/DetectedObject";
  }
...
template<class ContainerAllocator>
struct Definition< ::waytous_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::waytous_msgs::DetectedObject_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::waytous_msgs::DetectedObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::waytous_msgs::DetectedObject_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "fusion_state: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.fusion_state);
    s << indent << "type: ";
...
#endif // WAYTOUS_MSGS_MESSAGE_DETECTEDOBJECT_H
